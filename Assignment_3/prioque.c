...
// read input
while (scanf("%d %d %d %d %d", &processes[num_of_processes].time, &processes[num_of_processes].pid, 
              &processes[num_of_processes].run, &processes[num_of_processes].io, &processes[num_of_processes].repeat) != EOF){
  num_of_processes++;
}
